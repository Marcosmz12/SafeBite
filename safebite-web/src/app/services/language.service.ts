...
export class LanguageService {
  ...
  private dictionary: any = {
    es: {
        ...
        chat_resp_lacteos: '¡Entendido! Puedes activar el filtro de "Sin Lactosa" en tu perfil para que SafeBite te avise de productos con leche.',
        chat_resp_otros: 'Si tienes alergias específicas (frutos secos, soja, etc.), puedes añadirlas manualmente en la sección de "Mi Perfil".',
        chat_btn_perfil: 'Ir al Perfil',
        chat_btn_menu: 'Menú Principal',
      ...
      en: {
        ...
        chat_resp_lacteos: 'Understood! You can activate the "Lactose-Free" filter in your profile so SafeBite alerts you about dairy products.',
        chat_resp_otros: 'If you have specific allergies (nuts, soy, etc.), you can add them manually in the "My Profile" section.',
        chat_btn_perfil: 'Go to Profile',
        chat_btn_menu: 'Main Menu',
        chat_opt_gluten: 'Gluten',
